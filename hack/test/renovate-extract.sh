...
expect_status 0 && expect_out 'README.md: 2 of 2' && expect_out '# renovate: comments: 2 of 2' && pass
...
expect_status 1 && expect_err '.github/workflows/lint.yml: not extracted: # renovate: datasource=docker depName=rhysd/actionlint' && pass
