...
[Trivy](https://trivy.dev), each of its platforms separately, and the results
land in the repository's *Security* tab, one category per tag and
...
the tag you pinned has drifted since.
